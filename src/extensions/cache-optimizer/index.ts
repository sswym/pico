...
const DISABLE_ENV = "SRCODE_CACHE_OPTIMIZER_DISABLE";
const NO_PROMPT_REWRITE_ENV = "SRCODE_CACHE_OPTIMIZER_NO_PROMPT_REWRITE";
const NO_SKILL_COMPRESSION_ENV = "SRCODE_CACHE_OPTIMIZER_NO_SKILL_COMPRESSION";
const NO_OPENAI_CACHE_KEY_ENV = "SRCODE_CACHE_OPTIMIZER_NO_OPENAI_CACHE_KEY";
const ALLOW_PROXY_LONG_RETENTION_ENV = "SRCODE_CACHE_OPTIMIZER_ALLOW_PROXY_LONG_RETENTION";
